...
public class JobExecuteResult
{
	...
	public static JobExecuteResult CreateJobExecuteResultInternal(Guid executionId, bool @continue, JobExecuteStatus status)
		=> new JobExecuteResult(executionId, @continue, status);
}
